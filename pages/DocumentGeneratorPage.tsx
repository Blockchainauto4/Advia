      ...
      <AccessControlOverlay isAllowed={isAllowed} featureName="Gerador de Documentos">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg flex flex-col">
            ...
            {/* Output Area */}
            <div className="bg-slate-50 border border-slate-200 rounded-md p-4 flex-grow overflow-y-auto min-h-[400px]">
              ...
              {isLoading && (
                <div>
                  <div className="flex items-center text-sm text-slate-600 mb-4 p-2 bg-indigo-50 border-l-4 border-indigo-400 rounded-r-md">
                  ...
                  <div className="bg-slate-900 text-slate-100 p-4 rounded-lg font-mono text-xs overflow-x-auto">
                      <p className="text-slate-400 text-xs mb-2">// Recebendo dados brutos da IA...</p>
                      <pre><code>{streamingText}</code></pre>
                  </div>
                </div>
              )}
